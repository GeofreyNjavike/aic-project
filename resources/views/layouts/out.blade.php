...
<head>
    ...
    <title>AGRIBUSINESS INVESTMENT CONSULTANCY
    </title>
...
<body>
    ...
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>AIC</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
    ...
    <a href="#" class="back-to-top d-flex align-items-center justify-content-center"
        style="background-color: #0077be;"><i class="bi bi-arrow-up-short"></i></a>
