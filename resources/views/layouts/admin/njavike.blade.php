...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="{{ url('/') }}">AIC</a>
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                {{-- <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModalhr">CREATE SLIDER CONTENT</a>
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModalab">CREATE ABOUT US</a>
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModalabvid">CREATE VIDEO URLs</a>
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModald">Tengeneza Taarifa</a>
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModaly">Tengeneza Tukio</a>
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModalz">Atendance</a>
                                ...
                                <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModalc">Add User</a>
                                        <a class="nav-link" type="button" data-toggle="modal"
                                            data-target="#exampleModalx">View Users</a>

                                    </nav>
                                </div>
                            </nav>
                        </div>
                        <div class="sb-sidenav-menu-heading">From third Parties</div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; AIC 2020</div>
                        <div>
