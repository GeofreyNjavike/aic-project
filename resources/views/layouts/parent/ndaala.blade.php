...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="{{ url('home') }}">AIC</a>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="layout-static.html" class="btn btn-info btn-lg"
                                    data-toggle="modal" data-target="#myModal">Msajili Mwanao</a>
                                <a class="nav-link" href="layout-static.html" class="btn btn-info btn-lg"
                                    data-toggle="modal" data-target="#myModal1">Fanya Malipo</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="" class="btn btn-info btn-lg" data-toggle="modal"
                                    data-target="#exampleModalk">Toa Ushahidi</a>
                        ...
                        <a class="nav-link"
                            href="https://wa.me/+255712828561?text= Hello habari nahitaji kumsajili mwanangu"
