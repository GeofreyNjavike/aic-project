            ...
            <div class="carousel-inner" role="listbox">
                ...
                @foreach ($hero as $value)
                    <div class="carousel-item active"
                        style="background-image: url({{ asset('storage/heros/' . $value->hero_image) }})">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown" style="text-align: center;">Karibu
                                    <span><b>{{ $value->hero_head }}</b></span>
                                </h2>
                                <p class="animate__animated animate__fadeInUp">{{ $value->hero_content }}</p>
                                <a href="{{ url('home') }}"
                                    class="btn-get-started animate__animated animate__fadeInUp scrollto">Karibu>>></a>
                            </div>
                        </div>
                    </div>
                @endforeach
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <p>
                                    Kwasababu ya miji kukua na changamoto kama usalama watoto wanafungiwa kwenye mageti na
                                    wanaenda na kurudi kutoka shule kwa magari hawapati nafasi ya kuchaza na kujichanganya
                                    na wenzao mtaani. Hii inapelekea hata kuwa na afya mbovu n.k
                                </p>
                                <div class="collapse" id="collapseExample123">
                                    <p>{{ $value->about_content }}</p>
                                </div>
                            </div>
                            <div class="card-footer">
                                <button type="button" data-toggle="collapse" href="#collapseExample123"
                                    class="btn btn-primary">Jifunze Zaidi</button>
                            </div>
                        </div>
    ...
    <section id="cta" class="cta">
        <div class="container" data-aos="zoom-in">
            ...
            <div class="text-center">
                <h3>Chukua Hatua</h3>
                <p> Tupo kukusikiliza na kukusaidia katika kuijenga afya ya mwanao na kuimarisha taifa lijalo, Karibu Kisota
                    Community sports center, Sehemu sahihi kwaajili ya mafunzo ya michezo kwa mwanao.</p>
                    ...
                    <div class="card-body">
                        ...
                        <div id="carouselExampleControls1" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100 rounded" style="height: 400px; width: 100%"
                                        src="{{ asset('storage/app/public/events/1.jpg') }}" alt="First slide">
                                </div>
                                @foreach ($events as $ev)
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="container1">
                                            <img class="d-block w-100" style="height: 400px; width: 100%"
                                                src="{{ asset('storage/events/' . $ev->image) }}" alt="Second slide"
                                                class="rounded">
                    ...
                    <div class="card-body">
                        ...
                        <div id="carouselExampleControls1" class="carousel slide" data-ride="carousel">
                            ...
                            @foreach ($first_video as $value1)
                                <iframe width="100%" height="430" @if (isset($first_video))
                    ...
                    @foreach ($info as $info)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <img src="{{ asset('storage/app/public/infos/' . $info->faili) }}" alt=""
                                    class="rounded" style="height: 100%; width: 100%;">
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <p> {{ $info->ujumbe }} </p><span><a
                                                href="{{ URL::to('taarifa/' . $info->id) }}">Read more >>></a></span>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    ...
                    @foreach ($second_video as $value)
                        <iframe width="100%" height="430" @if (isset($second_video))
                ...
                <div class="col-lg-8 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <div class="testimonials-slider swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events aos-init aos-animate"
                        data-aos="fade-up" data-aos-delay="100">
                        <div class="swiper-wrapper"
                            style="transform: translate3d(-1890px, 0px, 0px); transition-duration: 0ms;"
                            id="swiper-wrapper-518a139b194721050" aria-live="off">
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                                data-swiper-slide-index="3" style="width: 358px; margin-right: 20px;" role="group"
                                aria-label="1 / 9">
                            ...
                            @foreach ($users as $a)
                                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="3"
                                    style="width: 358px; margin-right: 20px;" role="group" aria-label="6 / 9">
                                    <div class="testimonial-item">
                                        <p>
                                            <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        <div class="row">
                                        ...
                                        <img src="{{ asset('storage/app/public/parents/' . $a->parent_image) }}"
                ...
                <div class="col-lg-6">
                    ...
                    <form action="{{ URL::to('customer/contact') }}" method="post" role="form">
                        ...
                        <div class="form-group mt-3">
                            <input type="text" class="form-control" name="customer_subject" id="subject"
                                placeholder="Subject" required="">
                        </div>
                        <div class="form-group mt-3">
                            <textarea class="form-control" name="customer_message" rows="5" placeholder="Message"
                                required=""></textarea>
                        </div>
                        <div class="my-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <a href="https://wa.me/+255712828561?text= Hello habari nahitaji kumsajili mwanangu"
                                class="fa fa-whatsapp" style="color: #075e54;"></a>
                        </div>
                    </div>
                </div>
